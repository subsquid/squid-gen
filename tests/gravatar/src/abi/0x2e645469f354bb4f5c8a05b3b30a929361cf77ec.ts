...
import {ABI_JSON} from './0x2e645469f354bb4f5c8a05b3b30a929361cf77ec.abi'
...
export const functions = {
    ...
    gravatarToOwner: new Func<[_: ethers.BigNumber], {}, string>(
        abi, '0x88d0d391'
    ),
    ownerToGravatar: new Func<[_: string], {}, ethers.BigNumber>(
        abi, '0xa5ac3634'
    ),
    ...
    gravatars: new Func<[_: ethers.BigNumber], {}, ([owner: string, displayName: string, imageUrl: string] & {owner: string, displayName: string, imageUrl: string})>(
        abi, '0xd5ce24ed'
    ),
}
